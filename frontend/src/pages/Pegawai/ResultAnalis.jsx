    ...
    <>
      <div className="flex flex-col px-16 ">
        ...
        <div className="flex justify-around mt-10 vm:flex-col vm:gap-5">
          <img
            className="w-[400px] bg-cover object-contain"
          ...
          <table className="font-bold">
            <tbody>
              <tr>
                <td>Ukuran : </td>
                <td>
                  {data.egg_info[0].predicted_length.toFixed(2)} Cm x{" "}
                  {data.egg_info[0].predicted_width.toFixed(2)} Cm
                </td>
              </tr>
              <tr>
                <td>Kondisi : </td>
        ...
        <div className="flex vm:flex-col gap-4 mt-5 justify-center mb-10">
          <BoxInformation
            grade={"A"}
            panjang={"> 6 CM"}
            lebar={"> 4.7 CM"}
